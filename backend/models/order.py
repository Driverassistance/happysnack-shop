...
class Order(Base):
    ...
    status = Column(String, nullable=False, default="new")  # new, confirmed, preparing, delivering, delivered, cancelled
    delivery_address = Column(String)
    delivery_date = Column(Date, nullable=True)
    delivery_time_slot = Column(String, nullable=True)  # morning, afternoon, evening
...
class OrderItem(Base):
    ...
    product_name = Column(String, nullable=False)  # Сохраняем название на момент заказа
