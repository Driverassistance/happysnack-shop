...
async def cmd_start(message: types.Message):
    ...
    if not user:
        ...
        await message.answer(
            ...
            "и напитков в Казахстане с опытом работы более 20 лет.\n\n"
...
async def callback_about_company(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        "📊 <b>Мы на рынке более 20 лет</b>\n"
        "Начинали с небольшого склада, сегодня — один из крупнейших "
        ...
        "👥 <b>Команда:</b>\n"
        "11 человек, включая 7 торговых представителей\n\n"
...
async def callback_our_products(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        "• 15+ вкусов\n"
        "• Разные форматы: 100г, 200г, коробки\n"
        "• Маржа для вас: до 60%!\n\n"
        "🥔 <b>ЧИПСЫ:</b>\n"
        "• Lay's, Pringles, Estrella\n"
        "• Doritos, Cheetos\n"
        "• И другие популярные бренды\n\n"
        "🍪 <b>СНЕКИ И СУХАРИКИ:</b>\n"
        "• Кириешки, сухарики\n"
        "• Орешки, семечки\n"
        "• Крекеры, печенье\n\n"
        "🥤 <b>НАПИТКИ:</b>\n"
        ...
        "Следим за трендами и предлагаем то, что продается.",
        parse_mode="HTML",
        reply_markup=keyboard
    )
    await callback.answer()
