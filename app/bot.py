...
async def callback_our_products(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        "• 15+ вкусов (сыр, карамель, BBQ, острый, сладкий...)\n"
        "• Форматы: 100г, 200г, коробки по 12 шт\n"
        ...
        "• Соки Rich, Добрый\n"
        "• Вода Bonaqua, BonAqua\n"
        "Маржа: 15-25%\n\n"
        "🥐 <b>ВЫПЕЧКА:</b>\n"
        "• Круассаны\n"
        "• Кексы Ever GO, Хлебцы\n"
        "• Вафли\n"
        "Маржа: 25-35%\n\n"
        "✨ <b>Всего 200+ позиций!</b>",
        parse_mode="HTML",
        reply_markup=keyboard
    )
    await callback.answer()
        ...
        if not user:
            ...
            if sales_assistant:
                ...
                await message.answer(
                    "🤖 Привет! Я AI-ассистент HappySnack!\n\n"
                    "🎁 <b>Специально для новых клиентов - 5,000₸ бонусов при регистрации!</b>\n\n"
                    "Нажмите /start чтобы узнать больше и зарегистрироваться! 🚀",
                    parse_mode="HTML"
                )
            return
